...
\bibitem{c1} Kittler, J., and Illingworth, J. (1986). Minimum error thresholding. Pattern Recognition, pp. 19, 41 - 47. 
\bibitem{c2} Zahara, E., Fan, S.-K. S., and Tsai, D. M. (2005). Optimal multithresholding using a hybrid optimization approach. Pattern Recognition Letter, 26, 1082 – 1095.
\bibitem{c3} Wang, S., Chung, F. L., and Xiong, F. (2008). A novel image thresholding method based on Parzen window estimate. Pattern Recognition, 41, 117–129.
\bibitem{c4} Otsu, N. (1979). A threshold selection method from gray-level histograms. IEEE Transactions on Systems, Man, Cybernetics, SMC - 9, 62 – 66.
\bibitem{c5} Shoo, P. K., Soltani, S., Wong, A. K. C., and Chen, Y. C. (1988). A survey of thresholding techniques. Computer Vision Graphics and Image Processing, 41, 233 – 236.
\bibitem{c6} Liao, P. S., Chen, T. S., and Chung, P. C. (2001). A fast algorithm for multilevel thresholding. Journal of Information Science and Engineering, 17, 713–727.
